...
const Comidas = () => {
    ...
    return(
        ...
        <main>
            ...
            <div className='item_menor back_color'><Link to="/sanduiches" style={{ textDecoration: 'none' }}>
                <img className="crop_min img_menor" src={sanduiches}></img>
            <h1>Sanduíches</h1></Link></div>
            <div className='item_menor back_color'><Link to="/pizzas" style={{ textDecoration: 'none' }}>
                <img className="crop_min img_menor" src={pizzas}></img>
            <h1>Pizzas</h1></Link></div>
            <div className='item_menor back_color'><Link to="/salgados" style={{ textDecoration: 'none' }}>
                <img className="crop_min img_menor" src={salgados}></img>
            <h1>Salgados</h1></Link></div>
            <div className='item_menor back_color'><Link to="/combos" style={{ textDecoration: 'none' }}>
                <img className="crop_min img_menor" src={combos}></img>
            <h1>Combos</h1></Link></div>
            <div className='item_menor back_color'><Link to="/hotdogs" style={{ textDecoration: 'none' }}>
                <img className="crop_min img_menor" src={hotdogs}></img>
            <h1>Hot Dogs</h1></Link></div>
            <div className='item_menor back_color'><Link to="/petiscos" style={{ textDecoration: 'none' }}>
